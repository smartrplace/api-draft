...
public class AddEntryButtonBak extends RedirectButton {
	...
	public AddEntryButtonBak(WidgetPage<?> page, String id, String pid, String text,
	...
	public void onGET(OgemaHttpRequest req) {
		if(SPPageUtil.getPageData(exPage.getAccessData(req), type, PageType.EDIT_PAGE) == null)
			disable(req);
		else enable(req);
	}
	@Override
	public void onPrePOST(String data, OgemaHttpRequest req) {
		...
		NavigationPublicPageData pageData = SPPageUtil.getPageData(appData, type, PageType.EDIT_PAGE);
