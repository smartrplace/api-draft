 ...
 *
 */
public abstract class VirtualSensorKPIMgmtBak {
	...
	public VirtualSensorKPIMgmtBak(TimeseriesSimpleProcUtilBase util, Logger logger, DatapointService dpService) {
	 ...
	 * @param dpService
	 */
	public VirtualSensorKPIMgmtBak(TimeseriesSimpleProcUtilBase util, DataRecorder dataRecorder, Logger logger, DatapointService dpService) {
