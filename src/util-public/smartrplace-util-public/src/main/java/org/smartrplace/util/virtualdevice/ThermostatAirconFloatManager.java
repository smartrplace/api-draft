...
public class ThermostatAirconFloatManager extends SetpointControlManager<FloatResource> {
	...
	private ThermostatAirconFloatManager(ApplicationManagerPlus appManPlus) {
		super(appManPlus);
	...
	private static ThermostatAirconFloatManager instance = null;
	...
	@Override
	public Resource getSensor(FloatResource setp) {
		Resource sensor = setp.getParent(); //ResourceHelper.getFirstParentOfType(setp, TemperatureSensor.class);
		return sensor;
	}
	
	@Override
	public SensorDataFloat2Float registerSensor(FloatResource setp, Resource sensor,
