...
@Component
@Deprecated
public class DefaultQualityEvalProviderV1 extends QualityEvalProviderBase {
	/** Adapt these values to your provider*/
    public final static String ID = "adefault-quality_v1_eval_provider-v1";
    public final static String LABEL = "V1 Default Quality: Gap evaluation provider V1";
    public final static String DESCRIPTION = "V1 Default Quality: Provides gap evaluation, additional information in log file V1";
	...
	protected List<String> getSensorsToFilerOut(String currentGwId) {
		Object dataTouse = OGEMAConfigurations.getObject(DefaultQualityEvalProviderV1.class.getName(), SENSORS_TO_FILTEROUT_PROP, currentGwId);
		if(dataTouse != null && dataTouse instanceof List)
			return (List<String>)dataTouse;
		return super.getSensorsToFilerOut(currentGwId);
	}
	
    public DefaultQualityEvalProviderV1() {
    ...
    public final static GenericGaRoResultType TS_TOTAL = new GenericGaRoResultType("TS_TOTAL",
		...
		public SingleEvaluationResult getEvalResult(GenericGaRoEvaluationCore ec, ResultType rt,
			...
			int num;
			Object dataTouse = OGEMAConfigurations.getObject(DefaultQualityEvalProviderV1.class.getName(), TS_TOTAL_PROP, cec.currentGwId);
